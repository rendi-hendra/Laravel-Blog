    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-10 mt-5">
            <div class=" overflow-hidden mx-5 rounded-md">
                ...
                {{-- Postingan --}}
                <div class="rounded-md py-5 shadow-lg px-5 m-5 md:mt-10 sm:px-10 sm:m-5 sm:mx-10 bg-[#12141D] border border-black">
                    ...
                    <div class="text-[#E7E8F2]">
                        <p class="mt-1">By : <a href="/authors/{{ $ps->author->username }}" class="text-[#EB4432] hover:font-semibold">{{ $ps->author->name }}</a>
                        </p>
                        <p class="">
                            Category :
                            <a href="/category/{{ $ps->category->slug }}" class="text-[#EB4432] hover:font-semibold">
                                {{ $ps->category->name }}
                            </a>
                        </p>
                    </div>
            ...
            <a href="#home" class="hidden sup sdown sd smp ease-in">
                <div class="fixed animate-bounce opacity-0 sd ease-out bottom-5 right-2 md:right-2 w-12 h-12 bg-zinc-800 rounded-full md:hover:bg-black">
                    <div class="mt-3 ml-3">
